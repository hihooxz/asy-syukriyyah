        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"  >
          ...
          <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <input type="text" name="text"  name="nama_pegawai[<?php echo $i?>]" class="form-control">
                  </div>
                </div>
                <div class="col-md-1">
                    <select class="form-control" name="jenis_kelamin[<?php echo $i;?>]">
                        <option value="1">L</option>
                        <option value="2">P</option>
                    </select>
                </div>
                <div class="col-md-2">
                  <select class="form-control" name="kandung[<?php echo $i;?>]">
                        <option value="0">Kandung</option>
                        <option value="1">Bukan Kandung</option>
                    </select>
                </div>
