      ...
      <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"  >
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input  type="text" name="tahun_masuk_pd" class="form-control col-md-7 col-xs-12" value="<?php if($result['tahun_masuk_pd'] != 0) echo $result['tahun_masuk_pd']?>">
            </div>
          </div>
