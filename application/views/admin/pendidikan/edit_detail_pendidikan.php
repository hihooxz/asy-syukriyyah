          ...
          <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="col-md-5">
                          <input type="text"  placeholder="Lamanya" name="lamanya1" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Nama Lembaga " name="lembaga1" class="form-control">
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Jenis " name="jenis1" class="form-control">
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <input type="text"  placeholder="Tahun " name="tahun2" class="form-control">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <input type="text"  placeholder="Lamanya" name="lamanya2" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Nama Lembaga " name="lembaga2" class="form-control">
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Jenis " name="jenis2" class="form-control">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <input type="text"  placeholder="Tahun " name="tahun3" class="form-control">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <input type="text"  placeholder="Lamanya" name="lamanya3" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Nama Lembaga " name="lembaga3" class="form-control">
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Jenis " name="jenis3" class="form-control">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <input type="text"  placeholder="Tahun " name="tahun4" class="form-control">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <input type="text"  placeholder="Lamanya" name="lamanya4" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Nama Lembaga " name="lembaga4" class="form-control">
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Jenis " name="jenis4" class="form-control">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <input type="text"  placeholder="Tahun " name="tahun5" class="form-control">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <input type="text"  placeholder="Lamanya" name="lamanya5" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Nama Lembaga " name="lembaga5" class="form-control">
                      </div>
                      <div class="col-md-3">
                        <input type="text"  placeholder="Jenis " name="jenis5" class="form-control">
                      </div>
                    </div>
                    <div class="row">
