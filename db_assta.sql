...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2016 at 08:07 AM
...
--
-- Table structure for table `as_data_keluarga`
--

CREATE TABLE IF NOT EXISTS `as_data_keluarga` (
  `id_data_keluarga` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `as_data_keluarga`
--

INSERT INTO `as_data_keluarga` (`id_data_keluarga`, `id_keluarga`, `hub_keluarga`, `sort_order`, `nama_anggota`, `jenis_kelamin`, `kandung`, `pekerjaan`) VALUES
(1, 297, 0, 1, 'Zaenal Abidin', 1, 0, 'Guru'),
(2, 297, 1, 2, 'Fulanah', 0, 1, 'Non Guru');

-- --------------------------------------------------------

--
-- Table structure for table `as_keg_sosial`
--

CREATE TABLE IF NOT EXISTS `as_keg_sosial` (
  `id_keg_sosial` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_keg_sosial`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `as_keluarga`
--
...
--
-- Dumping data for table `as_keluarga`
--
...
(295, 273, 1, '', '', 0, 0, '', '', 0),
(296, 304, 0, '', '', 0, 0, '', '', 0),
(297, 285, 0, 'Fulanah', '-', 0, 0, '-', '-', 0);

-- --------------------------------------------------------

--
-- Table structure for table `as_nonformal`
--

CREATE TABLE IF NOT EXISTS `as_nonformal` (
  `id_nonformal` int(11) NOT NULL AUTO_INCREMENT,
  `id_pendidikan` int(11) NOT NULL,
  `lembaga` varchar(200) NOT NULL,
  `tahun` varchar(10) NOT NULL,
  `lamanya` varchar(100) NOT NULL,
  `sort_order` tinyint(4) NOT NULL,
  `jenis` varchar(200) NOT NULL COMMENT '1.Pelathan,2.Kursus,3.Job Training',
  `diutus` tinyint(2) NOT NULL COMMENT '1.Ya,0.Tidak',
  PRIMARY KEY (`id_nonformal`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `as_pegawai`
--
...
--
-- Dumping data for table `as_pegawai`
--
...
--
-- Table structure for table `as_pendidikan`
--
...
--
-- Dumping data for table `as_pendidikan`
--
...
--
-- Table structure for table `as_pendidikan_formal`
--

CREATE TABLE IF NOT EXISTS `as_pendidikan_formal` (
  `id_pendidikan_normal` int(11) NOT NULL AUTO_INCREMENT,
  `id_pendidikan` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id_pendidikan_normal`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Dumping data for table `as_pendidikan_formal`
--

INSERT INTO `as_pendidikan_formal` (`id_pendidikan_normal`, `id_pendidikan`, `tingkat`, `tahun_masuk`, `tahun_selesai`, `nama_instansi`, `jurusan`) VALUES
(1, 297, '1', '2001', '2007', 'SD', ''),
(2, 297, '2', '2007', '2009', 'SMP', '');

-- --------------------------------------------------------

--
-- Table structure for table `as_riwayat_jabatan`
--

CREATE TABLE IF NOT EXISTS `as_riwayat_jabatan` (
  `id_riwayat_jabatan` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `as_riwayat_jabatan`
--

INSERT INTO `as_riwayat_jabatan` (`id_riwayat_jabatan`, `id_riwayat_kerja`, `sort_order`, `tahun_mulai`, `tahun_selesai`, `unit`, `jabatan`) VALUES
(1, 298, 1, '2005', '2006', 'TKIT', 'Guru'),
(2, 298, 2, '2006', '2009', 'SDIT', 'TU');

-- --------------------------------------------------------

--
-- Table structure for table `as_riwayat_jabatan_diluar`
--

CREATE TABLE IF NOT EXISTS `as_riwayat_jabatan_diluar` (
  `id_riwayat_jabatan_diluar` int(11) NOT NULL AUTO_INCREMENT,
  `id_riwayat_kerja` int(11) NOT NULL,
  `sort_order` tinyint(2) NOT NULL,
  ...
  PRIMARY KEY (`id_riwayat_jabatan_diluar`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `as_riwayat_jabatan_diluar`
--

INSERT INTO `as_riwayat_jabatan_diluar` (`id_riwayat_jabatan_diluar`, `id_riwayat_kerja`, `sort_order`, `tahun`, `nama_instansi`, `jabatan`, `alasan_keluar`) VALUES
(1, 298, 1, 2006, 'PT Adicipta Mangunkusumo', 'Office Boy', 'Nggak betah');

-- --------------------------------------------------------

--
-- Table structure for table `as_riwayat_kerja`
--
...
--
-- Dumping data for table `as_riwayat_kerja`
--
...
(1, 7, 'Kepala Sekolah', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(2, 8, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(3, 9, 'Office Woman', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(4, 52, 'Guru Al''qur''an', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(5, 51, 'Office Boy', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(6, 166, 'Wakabid. Kesiswaan', 8, 0, '0000-00-00', 5, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(7, 108, 'Piket', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(8, 140, 'Wakasek.Bid. Kurikulum', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(9, 47, 'Guru Save', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(10, 53, 'Walas 5A', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(11, 24, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(12, 40, 'Kebersihan', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(13, 156, 'Guru Tik', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(14, 136, 'Office Boy', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(15, 187, 'Guru Agama', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(16, 86, 'Walas 3A1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(17, 54, 'Walas 4B', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(18, 185, 'Koordinator Sentra', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(19, 204, 'Guru Save', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(20, 35, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(21, 55, 'Walas 2A1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(22, 56, 'Wakasek. Bid. Kesiswaan', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(23, 93, 'Guru OlahRaga', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(24, 121, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(25, 205, 'Guru Al''qur''an', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(26, 194, 'Walas 3 Cordova C', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(27, 113, 'Guru Save', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(28, 201, 'Guru Pend. 4 Mekkah', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(29, 148, 'Guru Al''qur''an', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(30, 191, 'Walas 3 Cordova D', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(31, 117, 'Walas 3D2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(32, 30, 'Guru Kelas', 6, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(33, 44, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(34, 57, 'Guru PAI', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(35, 198, 'Guru Pend. 3 Mekkah', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(36, 102, 'Walas 3D1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(37, 42, 'Guru Shadow', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(38, 133, 'Guru Bendahara', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(39, 134, 'Guru Biologi', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(40, 157, 'Walas 5 Mekkah', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(41, 58, 'Walas 4A', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(42, 43, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(43, 150, 'Guru Al''qur''an', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(44, 31, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(45, 10, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(46, 59, 'Walas 1A2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(47, 135, 'Guru /Walas IXB', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(48, 122, 'Guru Bid. Studi', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(49, 129, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(50, 60, 'Tata Usaha', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(51, 158, 'Walas 1 Cordova E', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(52, 65, 'Walas 1B1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(53, 159, 'Walas 3 Mekkah', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(54, 155, 'Walas 1 Cordova B', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(55, 64, 'Office Boy', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(56, 190, 'Walas 5 Cordova B', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(57, 137, 'Guru IPS', 9, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(58, 63, 'Guru Al''qur''an', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(59, 160, 'Wakabid. Sarpra', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(60, 62, 'Guru/Walas 3B2', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(61, 111, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(62, 123, 'Pustakawan', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(63, 11, 'Wakasek.Bid. Kurikulum', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(64, 39, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(65, 104, 'Walas 3 C2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(66, 12, 'Wakasek Bid. Sarpra', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(67, 97, 'Guru Save 2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(68, 105, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(69, 130, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(70, 182, 'Walas 2 Cordova C', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(71, 26, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(72, 161, 'Walas 1 Cordova C', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(73, 197, 'Walas 3 Cordova A', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(74, 49, 'Kepala Sekolah', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(75, 61, 'Wakabid. Kurikulum', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(76, 199, 'Walas 1 Cordova A', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(77, 37, 'Guru Shadow', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(78, 85, 'Walas 2 B1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(79, 33, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(80, 13, 'Guru Kelas', 0, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(81, 70, 'Walas 5B', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(82, 116, 'Walas 2C2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(83, 146, 'Tata Usaha', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(84, 124, 'Guru Bid. Studi', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(85, 131, 'Kepala Sekolah', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(86, 186, 'Tata Usaha', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(87, 106, 'Walas 3A2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(88, 100, 'Office Woman', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(89, 154, 'Kepala Sekolah', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(90, 181, 'Walas 4 Cordova C', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(91, 127, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(92, 95, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(93, 87, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(94, 206, 'Guru Al''qur''an', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(95, 14, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(96, 152, 'Guru Bid. Studi', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(97, 88, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(98, 69, 'Walas 2A2', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(99, 48, 'Office Woman', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(100, 162, 'Walas 6 Madinah', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(101, 25, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(102, 188, 'Walas 1 Cordova D', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(103, 163, 'Walas 4 Mekkah', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(104, 38, 'Guru Save', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(105, 68, 'Walas 2C1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(106, 165, 'Walas 3 Cordova E', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(107, 132, 'Wakasek. Bid. Kesiswaan', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(108, 196, 'Guru Bid. Studi', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(109, 107, 'Walas 2D1', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(110, 67, 'Guru PAI', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(111, 41, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(112, 167, 'Walas 4 Cordova D', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(113, 15, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(114, 66, 'Guru/Walas 6B', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(115, 96, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(116, 50, 'Walas 6A', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(117, 103, 'Walas 2D2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(118, 168, 'Walas 4 Cordova E', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(119, 71, 'Walas 6C', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(120, 147, 'Guru Al''qur''an', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(121, 145, 'Guru Bid. Studi', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(122, 203, 'Guru Bid. Studi', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(123, 90, 'Bendahara', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(124, 84, 'Walas 3B1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(125, 114, 'Walas 1C1', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(126, 16, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(127, 195, 'Office Boy', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(128, 22, 'Guru', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(129, 45, 'Guru`', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(130, 94, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(131, 202, 'Guru Bid. Studi', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(132, 149, 'Guru Piket', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(133, 153, 'Guru Bid. Studi', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(134, 178, 'Walas 2 Cordova F', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(135, 72, 'Office Boy', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(136, 36, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(137, 119, 'Office Boy', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(138, 73, 'Guru PAI', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(139, 176, 'Office Woman', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(140, 138, 'Guru Penjas', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(141, 109, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(142, 183, 'Walas 1 Cordova F', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(143, 170, 'Walas 5 Madinah', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(144, 115, 'Walas 1B2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(145, 74, 'Guru', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(146, 200, 'Guru Al''qur''an', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(147, 177, 'Walas 6 Mekkah', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(148, 46, 'Guru Shadow', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(149, 34, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(150, 17, 'Wakabid. Kesiswaan', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(151, 120, 'Guru Bid. Studi', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(152, 192, 'Walas 4 Cordova B', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(153, 142, 'Guru Mtk', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(154, 91, 'Koord. Sentra', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(155, 101, 'Walas 1 D1', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(156, 125, 'Guru Bid. Studi', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(157, 139, 'Guru /Walas IXA', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(158, 184, 'Walas 2 Cordova A', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(159, 76, 'Walas 4C', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(160, 75, 'Walas 6D', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(161, 110, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(162, 171, 'Office Boy', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(163, 172, 'Walas 3 Cordova B', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(164, 141, 'Guru/Walas VIIIA', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(165, 144, 'Guru/Walas VIIIB', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(166, 18, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(167, 77, 'Walas 5C', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(168, 89, 'Koordinator Qur''an', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(169, 78, 'Wakabid. Sarpra', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(170, 79, 'Walas 1A1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(171, 98, 'Walas 2B2', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(172, 80, 'KA.TU', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(173, 169, 'Guru Bhs Inggris', 8, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(174, 81, 'Walas 3C1', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(175, 28, 'Guru Kelas', 6, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(176, 151, 'Guru Bid. Studi', 9, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(177, 118, 'Guru Save', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(178, 92, 'Walas 1C2', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(179, 32, 'Guru Kelas', 6, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(180, 173, 'Guru Piket', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(181, 112, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(182, 189, 'Walas 2 Cordova E', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(183, 99, 'Guru Al''qur''an', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(184, 207, 'Guru Bid. Studi', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(185, 19, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(186, 20, 'Guru Save', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(187, 27, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(188, 29, 'TU', 6, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(189, 21, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(190, 82, 'Guru OlahRaga', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(191, 174, 'Wakabid. Kurikulum', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(192, 83, 'Walas 1D2', 7, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 0, 0, 0, '', 0),
(193, 175, 'Walas 4 Cordova A', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(194, 128, 'Guru Save', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(195, 179, 'Koordinator TU', 8, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(196, 180, 'Guru Al''qur''an', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(197, 126, 'Guru Save', 7, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(198, 23, 'Guru Kelas', 6, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(199, 143, 'Wakasek.Bid. Sarpra', 9, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(200, 193, 'Walas 2 Cordova B', 8, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(201, 0, '', 0, 0, '0000-00-00', 0, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(202, 225, 'Resepsionis', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(203, 211, 'Ka. Div. Adm & SDM', 3, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(204, 230, 'Staf Fas & Linkungan', 12, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 0, 0, 0, '', 0),
(205, 213, 'Ka. Div Keuangan', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(206, 214, 'Accounting', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(207, 226, 'Security', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(208, 229, 'Direktur LEKU', 5, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(209, 221, 'Office Boy', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(210, 234, 'Staf Leku', 5, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(211, 231, 'Adm. Piutang', 12, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(212, 235, 'Staf Leku', 5, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(213, 232, 'Adm. Piutang', 12, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(214, 216, 'Security', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(215, 217, 'Kasir', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(216, 228, 'Office Boy', 12, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(217, 227, 'Security', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(218, 209, 'Direktur LPP', 4, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(219, 218, 'Office Boy', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(220, 224, 'Kasir', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(221, 236, 'Admin Web', 12, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(222, 208, 'Direktur LPIA', 2, 0, '0000-00-00', 5, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(223, 215, 'STAF LPIA', 2, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(224, 237, 'Security', 12, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(225, 210, 'Kepala LDSM', 3, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(226, 219, 'Staf Umum', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(227, 220, 'Security', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(228, 212, 'Staf Umum', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(229, 233, 'Staf Leku', 5, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(230, 222, 'Juru Bayar', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(231, 223, 'Security', 12, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(232, 238, 'Kebersihan', 12, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(233, 259, 'Tata Usaha', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(234, 245, 'Wali Kelas XI', 11, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(235, 250, 'Wali Kelas X2', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(236, 240, 'Guru TIK', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(237, 239, 'Kepala Sekolah', 11, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(238, 247, 'Guru SBK', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(239, 254, 'Bendahara', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(240, 256, 'Koordinator Qur''an', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(241, 249, 'Wakasek. Bid. Kesiswaan', 11, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(242, 255, 'Guru TIK', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(243, 246, 'Pembina Osis', 11, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(244, 263, 'Guru Al''qur''an', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(245, 262, 'Kebersihan', 11, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(246, 241, 'Ka. Perpustakaan', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(247, 244, 'Guru OlahRaga', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(248, 242, 'Guru PAI', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(249, 251, 'Guru Bid. Studi', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(250, 266, 'Guru Bid. Studi', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(251, 257, 'Wali Kelas XI', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(252, 252, 'Wali Kelas X3', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(253, 260, 'Office Woman', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(254, 264, 'Guru Bid. Studi', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(255, 253, 'Wakasek.Bid. Kurikulum', 11, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(256, 267, 'Guru Al''qur''an', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(257, 265, 'Guru Bid. Studi', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(258, 243, 'Wk. Bid. SarPra', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(259, 261, 'Walas XII Ipa2', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(260, 248, 'Office Boy', 11, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(261, 258, 'Guru Al''qur''an', 11, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(262, 291, 'Guru/Walas VII C', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(263, 302, 'Office Boy', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(264, 297, 'Guru/Pembina Pramuka', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(265, 269, 'Guru/Walas VIII A', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(266, 288, 'Guru/Walas VIIID', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(267, 303, 'Guru Bid. Studi', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(268, 282, 'Tata Usaha', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(269, 287, 'Guru/Koord. Mentoring', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(270, 298, 'Guru', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(271, 293, 'Guru', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(272, 283, 'Guru/Walas VIID', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(273, 301, 'Guru Al''qur''an', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(274, 270, 'Wakabid. Sarpra', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(275, 290, 'Guru', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(276, 268, 'Kepala Sekolah', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(277, 275, 'WakasekBid. Kesiswaan', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(278, 271, 'Guru/Koord. Liftskill', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(279, 278, 'Tata Usaha', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(280, 274, 'Wakabid. Kurikulum', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(281, 294, 'Guru', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(282, 295, 'Guru/Koord. Lab', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(283, 279, 'Guru/Walas IXB', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(284, 289, 'Guru', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(285, 277, 'Kebersihan', 10, 0, '0000-00-00', 4, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(286, 292, 'Guru/Walas VIIIB', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(287, 276, 'Guru/ Bendahara', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(288, 272, 'Guru', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(289, 280, 'Guru/Koord. Qur''an', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(290, 281, 'Koord.Qur''an LPIA', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(291, 300, 'Guru Al-Qur''an', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(292, 299, 'Guru', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(293, 286, 'Guru/Walas VIIIC', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(294, 284, 'Pustakawan &Guru Piket', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(295, 296, 'Guru', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(296, 273, 'Guru/Koord. Bimbel', 10, 0, '0000-00-00', 1, '0000-00-00', '0000-00-00', 1, 0, 0, '', 0),
(297, 304, 'Office Boy', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 2, 0, 0, '', 0),
(298, 285, 'Guru / Walas VIIB', 10, 0, '0000-00-00', 2, '0000-00-00', '0000-00-00', 1, 3, 0, '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `as_saudara_kandung`
--

CREATE TABLE IF NOT EXISTS `as_saudara_kandung` (
  `id_saudara_kandung` int(11) NOT NULL AUTO_INCREMENT,
  `id_keluarga` int(11) NOT NULL,
  `sort_order` tinyint(2) NOT NULL,
...
--
-- Dumping data for table `as_saudara_kandung`
--

INSERT INTO `as_saudara_kandung` (`id_saudara_kandung`, `id_keluarga`, `sort_order`, `nama_saudara_kandung`, `jenis_kelamin`, `tanggal_lahir`, `pekerjaan`, `alamat`) VALUES
(1, 297, 1, 'Bambang', 1, '22 Tahun', 'PNS', 'Bandung');
...
(6, 'zarkasih', 'a8f5f167f44f4964e6c998dee827110c', 'zarkasih@gmail.com', 1, '2016-08-25 02:19:27', 'zarkasih ST'),
(7, 'dayat', 'a8f5f167f44f4964e6c998dee827110c', 'dayat@gmail.com', 2, '2016-08-25 04:55:02', 'dayat'),
(8, 'deni', 'a8f5f167f44f4964e6c998dee827110c', 'deni@gmail.com', 3, '2016-10-05 04:55:13', 'Deni'),
(9, 'jaelani', 'a8f5f167f44f4964e6c998dee827110c', 'jaelani@gmail.com', 4, '2016-10-05 04:56:27', 'H. Jaelani'),
(10, 'agus', 'a8f5f167f44f4964e6c998dee827110c', 'agus@gmail.com', 1, '2016-10-10 06:16:51', 'Agus ');
